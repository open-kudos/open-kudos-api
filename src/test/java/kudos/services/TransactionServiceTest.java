...
public class TransactionServiceTest {
    ...
    @Test
    public void testIfServiceFindsCompletedTransactions() throws TransactionException{
        when(transactionService.getAllTransactionsByStatus(any(Transaction.Status.class))).thenReturn(transactions);
        assertEquals(Transaction.Status.COMPLETED, transactionService.getAllTransactionsByStatus(Transaction.Status.COMPLETED).get(0).getStatus());
    }
