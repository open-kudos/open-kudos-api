...
//    public @ApiResponseObject @ResponseBody List<Challenge> createdChallengesByStatus(ChallengeStatus status) throws UserException {
...
//    public @ApiResponseObject @ResponseBody List<Challenge> participatedChallengesByStatus(ChallengeStatus status) throws UserException {
...
//    public @ApiResponseObject @ResponseBody List<Challenge> participatedChallengesByStatusPageable(ChallengeStatus status, int page, int pageSize) throws UserException {
...
//        if(!challenge.getParticipant().getId().equals(usersService.getLoggedUser().get().getId())) {
...
//
//        Challenge challenge = maybeChallenge.get();
//        if(!challenge.getCreator().getId().equals(usersService.getLoggedUser().get().getId())) {
