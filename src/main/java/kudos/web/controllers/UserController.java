...
//    public @ApiResponseObject @ResponseBody List<LeaderBoardItem> getTopReceivers(String period) throws UserException {
...
//    public @ApiResponseObject @ResponseBody List<LeaderBoardItem> getTopSenders(String period) throws UserException {
